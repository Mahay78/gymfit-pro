  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-5 shadow-xl space-y-4">
        <div>
          <span className="text-emerald-400 text-[10px] font-bold uppercase tracking-wider">Macros de Definición</span>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-slate-950 p-4 rounded-2xl border border-slate-850 space-y-3">
            <div className="flex justify-between items-center text-xs">
              ...
              <span className="font-mono text-emerald-400 font-bold">{dailyProtein}g / {proteinGoal}g</span>
            </div>
            ...
            <div className="flex gap-1.5 justify-center">
              <button onClick={() => onDailyProteinChange(dailyProtein + 25)} className="bg-emerald-500/10 border border-emerald-500/20 text-[10px] font-black text-emerald-400 px-2 py-1 rounded">
                +25g (Batido)
              </button>
              <button onClick={() => onDailyProteinChange(dailyProtein + 40)} className="bg-emerald-500/10 border border-emerald-500/20 text-[10px] font-black text-emerald-400 px-2 py-1 rounded">
                +40g (Comida)
              </button>
            </div>
          </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-5 shadow-xl space-y-4">
        <div className="border-b border-slate-800 pb-3">
          <span className="text-emerald-400 text-[10px] font-bold uppercase tracking-wider">Nutrición del Plan</span>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <div className="bg-gradient-to-br from-emerald-950/30 to-emerald-900/10 border border-emerald-500/30 p-3.5 rounded-2xl text-center">
            <p className="text-[10px] text-emerald-400 font-bold uppercase">Objetivo Pérdida de Grasa</p>
            <p className="text-xl font-black text-emerald-300 mt-1">{deficitCalories} kcal</p>
          </div>
        </div>
      </div>
          ...
          {cardioSessions.map(c => (
            <div key={c.id} className="bg-slate-950 border border-slate-850 p-3 rounded-xl flex items-center justify-between text-xs animate-fadeIn">
              ...
              <div className="flex items-center gap-2">
                <span className="text-emerald-400 font-bold font-mono">-{c.calories} kcal</span>
                <button
                  onClick={() => {
